...
class REPASiT(nn.Module):
    ...
    def _compute_repa_loss(
        ...
        """
        Compute per-sample REPA loss using norm L2 with outlier resistance.
    ...
    def _compute_aux_metrics(
        ...
        aux_losses["sample_gap_norm"] = sample_gap_norm  # (B,) for monitoring
